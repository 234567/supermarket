...
<div class="container">
    ...
    <div class="box">
        ...
        <div class="box-content">
            <a id="btn-add" href="<?php echo U('user/add');?>" class="btn btn-round btn-info ">
            ...
            <div id="branch_list">
                ...
                <table class="table table-striped table-bordered table-hover table-condensed">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><a href="<?php echo U('user/edit');?>?id=<?php echo ($vo["id"]); ?>"><?php echo ($vo["account"]); ?></a></td>
                            <td><?php echo ($vo["nickname"]); ?></td>
                            <td><?php echo (todate($vo["create_time"],'Y-m-d H#i#s')); ?></td>
                            <td><?php echo (todate($vo["last_login_time"],'Y-m-d H#i#s')); ?></td>
                            ...
                            <td>
                                <?php if(($vo["status"] == 1)): ?><a class="btn btn-danger btn-mini" href="<?php echo U('user/forbid');?>?id=<?php echo ($vo["id"]); ?>">禁用</a>
                                    <a class="btn btn-warning btn-mini" href="<?php echo U('user/del');?>?id=<?php echo ($vo["id"]); ?>">删除</a>
                                    <?php elseif($vo["status"] == 0): ?>
                                    <a class="btn btn-success btn-mini" href="<?php echo U('user/resume');?>?id=<?php echo ($vo["id"]); ?>">恢复</a>
                                    <a class="btn btn-warning btn-mini" href="<?php echo U('user/del');?>?id=<?php echo ($vo["id"]); ?>">删除</a>
                                    <?php else: ?>
                                    <a class="btn btn-inverse btn-mini" href="<?php echo U('user/recycle');?>?id=<?php echo ($vo["id"]); ?>">还原</a><?php endif; ?>
                            </td>
