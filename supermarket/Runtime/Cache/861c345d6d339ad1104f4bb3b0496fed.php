...
<div class="container">
    ...
    <div class="box">
        <div class="box-header well-small">
            <h4><i class="icon-edit"></i>编辑帐号</h4>
        </div>
        <div class="box-content">

            <form class="form-horizontal" method="post" action="<?php echo U('role/update');?>">
                ...
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="disabled" name="name" value="<?php echo ($vo["name"]); ?>"/>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="status">
                                <option <?php if(($vo["status"]) == "1"): ?>selected="selected"<?php endif; ?> value="1">启用</option>
                                <option <?php if(($vo["status"]) == "0"): ?>selected="selected"<?php endif; ?> value="0">禁用</option>
                            </select>
                        </div>
                    </div>
