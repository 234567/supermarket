...
<div class="container">
    ...
    <div class="box">
        <div class="box-header well-small">
            <h4><i class="icon-edit"></i>新增后台用户</h4>
        </div>
        <div class="box-content">

            <form class="form-horizontal" method="post" action="<?php echo U('user/insert');?>">
                <fieldset>
                    <legend>帐号信息<a class="btn btn-info pull-right" href="<?php echo U('user/index');?>">返回用户列表</a></legend>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id=""  name="role_id" class="" > <option value="1">超级管理员</option><option value="2" disabled="disabled">&nbsp;&nbsp;&nbsp;&nbsp;└ 分店负责人</option><option value="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;├ 销售员工</option><option value="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ 入库员工</option></select>
                        </div>
                    </div>
