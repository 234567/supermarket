...
<div class="container">
    ...
    <div class="box">
        <div class="box-header well-small">
            <h4><i class="icon-edit"></i>添加新节点</h4>
        </div>
        <div class="box-content">

            <form class="form-horizontal" method="post" action="<?php echo U('node/insert');?>">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id=""  name="level" class="" > <option value="1"  selected='selected'>项目</option><option value="2" >模块</option><option value="3" >操作</option></select>
                        </div>
                    </div>
